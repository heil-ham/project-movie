                    ...
                    <div class="card-body">
                        <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="runtime" id="runtime" class="form-control @error('runtime') is-invalid @enderror">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input min="1" max="10" type="number" name="rating" id="rating" class="form-control @error('rating') is-invalid @enderror">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="review" id="review" class="form-control @error('review') is-invalid @enderror" rows="5" placeholder="What do you think about the movie"></textarea>
